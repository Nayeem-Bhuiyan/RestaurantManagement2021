...
namespace RestaurantManagement.Areas.Auth.Controllers
{
    [Authorize]
    [Area("Auth")]
    public class AccountController : Controller
    {
        ...
        private IUserLogHistoryService _userLogHistoryService;
        ...
        public AccountController(UserManager<ApplicationUser> userManager,
            ...
            IUserLogHistoryService userLogHistoryService
        )
        {
            ...
            _userLogHistoryService = userLogHistoryService;
                ...
                if (userInfos != null)
                {
                    if (userInfos.isActive == 1)
                    {
                        ...
                        if (result.Succeeded)
                        {
                            ...
                            await _userLogHistoryService.SaveUserLogHistory(userLog);
                            ...
                            else if (userRole == "Computer Operator")
                            {
                                return RedirectToLocal(returnUrl);
                            }
